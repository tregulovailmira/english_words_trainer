...
void main() {
  ...
  test(
    'should return a valid model when all email and phone are missing',
    () async {
      final tUserWithoutEmailAndPhone = User(
          id: "90674aec-d6cb-402f-b8da-0254e9425c43",
          appMetadata: {
            "provider": "email",
            "providers": ["email"]
      ...
      const expectedUserModel = UserModel(
          id: '90674aec-d6cb-402f-b8da-0254e9425c43', email: '', phone: '');

      final result = UserModel.fromUserObject(tUserWithoutEmailAndPhone);
